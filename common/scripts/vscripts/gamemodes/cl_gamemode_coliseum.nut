...
void function ClGamemodeColiseum_ColiseumIntro_Internal( int enemyWinStreak, int enemyWins, int enemyLosses )
{
	...
	RuiSetString( rui, "playerName0", "SUB2INIQUITY" )
	...
	RuiSetString( rui, "playerName1", "SUB2INIQUITY" )
...
void function Epilogue_OnEnter()
{
	...
	AnnouncementData announcement = Announcement_Create( Localize( "#COLISEUM_WINNER", "Winner" ) )
	...
	RuiSetString( rui, "playerName", "Winner" )
